...
class CWFBCustCertPolicy: 
    ...
    public CComCoClass<CWFBCustCertPolicy, &CLSID_CWFBCustCertPolicy>
{
public:
    CWFBCustCertPolicy()
    {
...
BEGIN_COM_MAP(CWFBCustCertPolicy)
...
DECLARE_NOT_AGGREGATABLE(CWFBCustCertPolicy) 
...
public:
    ...
    CWFBCustCertPolicy *GetPolicy() { return(m_pPolicy); }
