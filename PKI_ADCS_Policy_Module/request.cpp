    ...
    OUT BOOL *pfEnableEnrolleeExtensions)
{
    ...
    *pfEnableEnrolleeExtensions = TRUE
	...
	//Get OU#1 Attribute value here:
	//need to add check for Null value here::
	hr = polGetRequestAttribute(pServer, wszAttrOU1, &strOUVal1);
	pwszstrOUVal1 = strOUVal1;
